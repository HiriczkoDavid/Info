...

{
    ...
    if (tomb[xpos+1][ypos+1] == -2 || tomb[xpos+1][ypos]==-2 || tomb[xpos+1][ypos-1] == 3 || tomb[xpos][ypos+1] == -2 || tomb[xpos+1][ypos-1] == 3 || tomb[xpos][ypos+1] == -2 || tomb[xpos+1][ypos-1] == 3 || tomb[xpos][ypos+1] == -2)
